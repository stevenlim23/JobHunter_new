			...
			<div class="wrap-login100">
                ...
                <form class="login100-form validate-form" action="" method="POST">
                    ...
                    <div class="container-login100-form-btn">
						<a href="jobplacer/register_placer.php" class="login100-form-btn">Register as Job Placer</a>	
                    </div>

                    <div class="container-login100-form-btn">
						<a href="jobsearch/register_hunter.php" class="login100-form-btn">Register as Job Hunter</a>
                    </div>
