...
$query = mysqli_query($sql, "SELECT * from tb_hunter a 
...
<body>
          ...
          <li>
            ...
            <div class="container">
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <h6><strong><?= $username; $sql->error ?></strong></h6>
                </div>
  ...
  ============================-->
          <div class="personal col-md-4 col-xs-12">
            ...
            <img class="w-100 rounded border" src="user_images/<?= $data['photo']?>" />
