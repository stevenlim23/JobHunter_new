    ...
    <h3>List Job Placed</h3>
        ...
        <thead>
          <tr id="HeadRow">
            ...
            <tbody>
        <?php
            $datajob = mysqli_query($sql,"SELECT a.id_job,a.title,a.jobdesc,a.experience,a.salary,a.location,a.industry,a.profile,a.postdate,a.status  
            from tb_job a
            inner join tb_placer b on a.id_placer = b.id_placer
            inner join tb_user c on b.id_user = c.id_user
