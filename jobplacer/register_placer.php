...
if(isset($_POST['register'])) {
    ...
    $jumlah = mysqli_num_rows($cekdata);
        ...
        if($jumlah > 0) {	
			...
			// die;
            $simpan = mysqli_query($sql, "INSERT INTO tb_user (`username`, `password`, `name`, `email`, `phone`,`role`,`status`) VALUES('$username','$password','$name','$email','$phone','jobplacer','closed')");
		...
		<div class="container-login100">
			<div class="wrap-login100 pt-5">
				<div class="login100-pic js-tilt" data-tilt style="margin-top:350px">
					<img src="../assets/login/images/placer.png" alt="IMG">
				</div>
				...
				<form class="login100-form validate-form" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Industry is required">
						<input type="text" class="input100" name="industry" placeholder="industry">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "profile is required">
						<input type="text" class="input100" name="profile" placeholder="profile">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Logo is required">
						<input type="file" class="input100" name="logo" style="padding-top: 10px">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
